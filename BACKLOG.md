...
## Future feature set session â€” June 10, 2026 (cloud, branch feat/share-bubble-wakeword)

Three Labs features behind flags (ALL default OFF â€” app identical to main
with toggles off): share-target ("ye raju ko bhejo", disabled activity-alias
â†’ wa.me drafts, never auto-send), floating bubble (overlay + special-use
...
behavior + Kotlin compile (no Android SDK there) â€” run
